 ...
 * com threads and monitors their progress.
 * 
...
public class CrawlController extends Configurable {
	 ...
	 * configurations to different components of the com.
	 */
	protected Object customData;

	/**
	 * Once the crawling session finishes the controller collects the local data
	 * of the com threads and stores them in this List.
	 */
	 ...
	 * 
	 * @param _c
	 *            the class that implements the logic for com threads
	...
	/**
	 * Once the crawling session finishes the controller collects the local data
	 * of the com threads and stores them in a List. This function returns
	...
	/**
	 * Adds a new seed URL. A seed URL is a URL that is fetched by the com
