...
/**
 * WebCrawler class in the Runnable class that is executed by each com
 * thread.
 * 
...
public class WebCrawler implements Runnable {
	...
	/**
	 * The id associated to the com thread running this instance
	 */
	protected int myId;

	/**
	 * The controller instance that has created this com thread. This
	...
	/**
	 * The thread within which this com instance is running.
	 */
	private Thread myThread;

	/**
	 * The parser that is used by this com instance to parse the content of
	 * the fetched pages.
	 */
	private Parser parser;

	/**
	 * The fetcher that is used by this com instance to fetch the content of
	 * pages from the web.
	 */
	private PageFetcher pageFetcher;

	/**
	 * The RobotstxtServer instance that is used by this com instance to
	 * determine whether the com is allowed to crawl the content of each
	 * page.
	 */
	private RobotstxtServer robotstxtServer;

	/**
	 * The DocIDServer that is used by this com instance to map each URL to
	 * a unique docid.
	 */
	...
	/**
	 * Is the current com instance waiting for new URLs? This field is
	 * mainly used by the controller to detect whether all of the com
	...
	/**
	 * Initializes the current instance of the com
	 * 
	 * @param myId
	 *            the id of this com instance
	...
	/**
	 * Get the id of the current com instance
	 * 
	 * @return the id of the current com instance
	 */
	public int getMyId() {
		return myId;
	}
	...
	/**
	 * This function is called just before starting the crawl by this com
	 * instance. It can be used for setting up the data structures or
	 * initializations needed by this com instance.
	 */
	public void onStart() {
	}
	 ...
	 * com instance. It can be used for persisting in-memory data or other
	 * finalization tasks.
	 */
	...
	/**
	 * The CrawlController instance that has created this com instance will
	 * call this function just before terminating this com thread. Classes
	 ...
	 * com whether the given url should be crawled or not. The following
