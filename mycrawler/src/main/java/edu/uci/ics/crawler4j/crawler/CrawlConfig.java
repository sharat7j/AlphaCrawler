...
public class CrawlConfig {
	...
	/**
	 * The folder which will be used by com for storing the intermediate
	...
	/**
	 * user-agent string that is used for representing your com to web
	...
	/**
	 * If com should run behind a proxy, this parameter can be used for
	...
	/**
	 * If com should run behind a proxy and user/pass is needed for
